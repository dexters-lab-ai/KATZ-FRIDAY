...
export class HelpCommand extends Command {
  ...
  async showHelpMenu(chatId) {
    const keyboard = Markup.inlineKeyboard([
      [Markup.button.callback("💱 Trading Features", "help_trading")],
      [Markup.button.callback("👛 Wallet Management", "help_wallets")],
      [Markup.button.callback("🤖 Automation & AI", "help_automation")],
      [Markup.button.callback("🛡️ Encryption & Security", "help_encryption")],
      [Markup.button.callback("⚙️ Advanced Architecture", "help_architecture")],
      [Markup.button.callback("🌟 Multi-Level Swaps & Scenarios", "help_scenarios")],
  ...
  async showTradingHelp(chatId) {
    const keyboard = Markup.inlineKeyboard([
      [Markup.button.callback("↩️ Back to Help", "back_to_help")],
    ]);
